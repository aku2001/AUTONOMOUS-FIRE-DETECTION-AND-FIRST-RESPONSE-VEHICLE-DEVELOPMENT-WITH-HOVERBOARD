...
{
  new (message_memory) tutorial_interfaces::msg::TempMsg(_init);
}

void TempMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::msg::TempMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TempMsg_message_member_array[2] = {
  {
    ...
    offsetof(tutorial_interfaces::msg::TempMsg, temp1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::TempMsg, temp2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TempMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(tutorial_interfaces::msg::TempMsg),
...
get_message_type_support_handle<tutorial_interfaces::msg::TempMsg>()
{
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::TempMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, msg, TempMsg)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::TempMsg_message_type_support_handle;
}
