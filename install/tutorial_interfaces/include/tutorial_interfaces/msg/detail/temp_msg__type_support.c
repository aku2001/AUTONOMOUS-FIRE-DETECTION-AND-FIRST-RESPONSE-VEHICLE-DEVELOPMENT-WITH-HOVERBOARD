...
#include <stddef.h>
#include "tutorial_interfaces/msg/detail/temp_msg__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tutorial_interfaces__msg__TempMsg__init(message_memory);
}

void TempMsg__rosidl_typesupport_introspection_c__TempMsg_fini_function(void * message_memory)
{
  tutorial_interfaces__msg__TempMsg__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TempMsg__rosidl_typesupport_introspection_c__TempMsg_message_member_array[2] = {
  {
    "temp1",  // name
    ...
    offsetof(tutorial_interfaces__msg__TempMsg, temp1),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__msg__TempMsg, temp2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TempMsg__rosidl_typesupport_introspection_c__TempMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(tutorial_interfaces__msg__TempMsg),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, msg, TempMsg)() {
