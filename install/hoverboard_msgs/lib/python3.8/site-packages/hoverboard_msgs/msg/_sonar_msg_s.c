...
bool hoverboard_msgs__msg__sonar_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hoverboard_msgs.msg._sonar_msg.SonarMsg", full_classname_dest, 39) == 0);
  }
  hoverboard_msgs__msg__SonarMsg * ros_message = _ros_message;
  {  // sonar1
...
PyObject * hoverboard_msgs__msg__sonar_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hoverboard_msgs.msg._sonar_msg");
