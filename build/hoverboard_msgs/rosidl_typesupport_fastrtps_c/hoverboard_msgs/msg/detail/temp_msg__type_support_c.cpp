...
#include "hoverboard_msgs/msg/detail/temp_msg__rosidl_typesupport_fastrtps_c.h"
...
static uint32_t _TempMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hoverboard_msgs__msg__TempMsg(
...
{
  return max_serialized_size_hoverboard_msgs__msg__TempMsg(
    full_bounded, 0);
}
