...
static const _TempMsg_type_support_symbol_names_t _TempMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hoverboard_msgs, msg, TempMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hoverboard_msgs, msg, TempMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hoverboard_msgs, msg, TempMsg)() {
  return &::hoverboard_msgs::msg::rosidl_typesupport_c::TempMsg_message_type_support_handle;
}
