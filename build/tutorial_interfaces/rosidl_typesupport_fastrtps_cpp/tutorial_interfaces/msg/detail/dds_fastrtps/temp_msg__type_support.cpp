...
#include "tutorial_interfaces/msg/detail/temp_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::TempMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::TempMsg & ros_message)
{
  // Member: temp1
  cdr >> ros_message.temp1;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::TempMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::TempMsg *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_TempMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, TempMsg)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_TempMsg__handle;
}
