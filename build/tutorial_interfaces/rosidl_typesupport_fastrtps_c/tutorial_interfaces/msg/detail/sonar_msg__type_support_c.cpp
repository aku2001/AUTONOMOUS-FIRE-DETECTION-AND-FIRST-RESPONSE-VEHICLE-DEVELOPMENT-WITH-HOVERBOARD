...
#include "tutorial_interfaces/msg/detail/sonar_msg__rosidl_typesupport_fastrtps_c.h"
...
using _SonarMsg__ros_msg_type = tutorial_interfaces__msg__SonarMsg;
...
size_t get_serialized_size_tutorial_interfaces__msg__SonarMsg(
  const void * untyped_ros_message,
...
static uint32_t _SonarMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__SonarMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__SonarMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tutorial_interfaces__msg__SonarMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, SonarMsg)() {
